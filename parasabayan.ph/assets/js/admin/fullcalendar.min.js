...
! function(t) {
	...
	function p(t) {
		var e, n = t.innerWidth() - t[0].clientWidth,
			i = t.innerHeight() - t[0].clientHeight;
	...
	function A(t, e) {
		var n, i, r;
		for (n = 0; n < Yt.length && (i = Yt[n], r = V(i, t, e), !(r >= 1 && ot(r))); n++);
		return i
	}
	...
	function ut(n, i, r) {
		...
		return e.isMoment(u) || U(u) || void 0 === u ? a = e.apply(null, n) : (s = !1, o = !1, c ? Ut.test(u) ? (u += "-01", n = [u], s = !0, o = !0) : (l = jt.exec(u)) && (s = !l[5], o = !0) : t.isArray(u) && (o = !0), a = i || s ? e.utc.apply(e, n) : e.apply(null, n), s ? (a._ambigTime = !0, a._ambigZone = !0) : r && (o ? a._ambigZone = !0 : c && a.utcOffset(u))), a._fullCalendar = !0, a
	}
	...
	function Dt(n) {
		var i, r, s, o, l = Ot.dataAttrPrefix;
	...
	function Ht(t) {
		...
		for (e = 0; e < t.length; e++) {
			for (n = t[e], i = 0; i < r.length && It(n, r[i]).length; i++);
	...
	function xt(t) {
		...
		for (e = 0; e < t.length; e++)
			for (n = t[e], i = 0; i < n.length; i++)
				for (r = n[i], r.forwardSegs = [], s = e + 1; s < t.length; s++) It(r, t[s], r.forwardSegs)
	}
	...
	function Rt(t) {
		...
		if (void 0 === t.forwardPressure) {
			for (e = 0; e < i.length; e++) n = i[e], Rt(n), r = Math.max(r, 1 + n.forwardPressure);
			t.forwardPressure = r
		}
	}
	...
	function It(t, e, n) {
		n = n || [];
		for (var i = 0; i < e.length; i++) kt(t, e[i]) && n.push(e[i]);
		return n
	}
	...
	function Bt(n, i) {
		...
		function o() {
			...
			var e = y();
			W = new Lt(e), U = _.header = e[0], j = _.footer = e[1], E(), b(), u(_.options.defaultView), _.options.handleWindowResize && (K = at(v, _.options.windowResizeDelay), t(window).resize(K))
		}
		...
		function u(e, n) {
			nt++;
			var i = Q && e && Q.type !== e;
			i && (F(), c()), !Q && e && (Q = _.view = et[e] || (et[e] = _.instantiateView(e)), Q.setElement(t("<div class='fc-view fc-" + e + "-view' />").appendTo(q)), W.proxyCall("activateButton", e)), Q && (J = Q.massageCurrentDate(J), Q.isDateSet && J >= Q.intervalStart && J < Q.intervalEnd || a() && (n && Q.captureInitialScroll(n), Q.setDate(J, n), n && Q.releaseScroll(), D())), i && z(), nt--
		}
		...
		var _ = this;
		se.needed(), _.render = s, _.destroy = l, _.rerenderEvents = m, _.changeView = u, _.select = T, _.unselect = C, _.prev = H, _.next = x, _.prevYear = R, _.nextYear = I, _.today = k, _.gotoDate = L, _.incrementDate = M, _.zoomTo = B, _.getDate = N, _.getCalendar = G, _.getView = O, _.option = A, _.publiclyTrigger = P, _.dynamicOverrides = {}, _.viewSpecCache = {}, _.optionHandlers = {}, _.overrides = t.extend({}, i), _.populateOptionsHash();
		var Y;
		_.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function(t, e, n, i, s, o, l) {
			...
			var t;
			return "local" === _.options.timezone ? (t = Ot.moment.apply(null, arguments), t.hasTime() && t.local()) : t = "UTC" === _.options.timezone ? Ot.moment.utc.apply(null, arguments) : Ot.moment.parseZone.apply(null, arguments), r(t), t
		...
		}, _.freezeContentHeight = F, _.thawContentHeight = z;
		var it = 0;
		_.initialize()
	}
	...
	function zt() {
		...
		function f(e, n) {
			...
			if (o) t.isFunction(o) ? (U.pushLoading(), o.call(U, q.clone(), Z.clone(), U.options.timezone, function(t) {
				...
				if (l) {
					...
					g && (h[g] = q.format()), p && (h[p] = Z.format()), U.options.timezone && "local" != U.options.timezone && (h[v] = U.options.timezone), U.pushLoading(), t.ajax(t.extend({}, ye, e, {
						data: h,
						success: function(e) {
							e = e || [];
		...
		function p(e) {
			var n, i, r = Ot.sourceNormalizers;
		...
		function x(t) {
			var e, n;
			for (e = 0; e < t.length; e++) n = t[e], n.start = U.moment(n.start), n.end ? n.end = U.moment(n.end) : n.end = null, Y(n, R(n));
			i()
		}
		...
		function W(e, n, i, r, s, o) {
			...
			return r && !r.valueOf() && (r = null), s && !s.valueOf() && (s = null), t.each(e, function(e, u) {
					...
					c = {
						...
						allDay: i
					}, V(d), n ? d.end = null : s && !d.end && (d.end = U.getDefaultEventEnd(d.allDay, d.start)), r && (d.start.add(r), d.end && d.end.add(r)), s && d.end.add(s), l && !d.allDay && (r || s) && (d.start.stripZone(), d.end && d.end.stripZone()), t.extend(u, o, d), Gt(u), a.push(function() {
						t.extend(u, c), Gt(u)
					})
				}),
				function() {
		...
		var U = this;
		U.requestEvents = n, U.reportEventChange = i, U.isFetchNeeded = s, U.fetchEvents = o, U.fetchEventSources = u, U.refetchEvents = l, U.refetchEventSources = a, U.getEventSources = S, U.getEventSourceById = w, U.addEventSource = g, U.removeEventSource = v, U.removeEventSources = m, U.updateEvent = H, U.updateEvents = x, U.renderEvent = k, U.renderEvents = L, U.removeEvents = M, U.clientEvents = B, U.mutateEvent = Y, U.normalizeEventDates = V, U.normalizeEventTimes = P;
		var q, Z, $, Q = {
				events: []
			},
			tt = [Q],
	...
	t.fn.fullCalendar = function(e) {
		...
		return this.each(function(r, s) {
			...
			"string" == typeof e ? a && t.isFunction(a[e]) && (o = a[e].apply(a, n), r || (i = o), "destroy" === e && l.removeData("fullCalendar")) : a || (a = new fe(l, e), l.data("fullCalendar", a), a.render())
		}), i
	};
	var Vt = ["header", "footer", "buttonText", "buttonIcons", "themeButtonIcons"];
	Ot.intersectRanges = F, Ot.applyAll = K, Ot.debounce = at, Ot.isInt = ot, Ot.htmlEscape = tt, Ot.cssToStr = nt, Ot.proxy = lt, Ot.capitaliseFirstLetter = rt, Ot.getOuterRect = h, Ot.getClientRect = f, Ot.getContentRect = g, Ot.getScrollbarWidths = p;
	var Pt = null;
	Ot.preventDefault = H, Ot.intersectRects = x, Ot.parseFieldSpecs = L, Ot.compareByFieldSpecs = M, Ot.compareByFieldSpec = B, Ot.flexibleCompare = N, Ot.computeIntervalUnit = A, Ot.divideRangeByDuration = P, Ot.divideDurationByDuration = _, Ot.multiplyDuration = Y, Ot.durationHasTime = W;
	...
	Ot.log = function() {
		...
		var t = window.console;
		return t && t.warn ? t.warn.apply(t, arguments) : Ot.log.apply(Ot, arguments)
	};
	...
	var Ut = /^\s*\d{4}-\d\d$/,
		...
		qt = e.fn,
		Zt = t.extend({}, qt),
		$t = e.momentProperties;
	$t.push("_fullCalendar"), $t.push("_ambigTime"), $t.push("_ambigZone"), Ot.moment = function() {
			return ut(arguments)
			...
			return null == t && "function" == typeof e ? e(this) : "ISO" === e ? Zt.isoWeek.apply(this, arguments) : Zt.week.apply(this, arguments)
		}, qt.time = function(t) {
			if (!this._fullCalendar) return Zt.time.apply(this, arguments);
		...
		function() {
			...
			function n(t, e, n, s, o) {
				var l;
				return t = Ot.moment.parseZone(t), e = Ot.moment.parseZone(e), l = t.localeData(), n = l.longDateFormat(n) || n, i(r(n), t, e, s || " - ", o)
			}
			...
			Ot.formatDate = t, Ot.formatRange = n, Ot.oldMomentFormat = e, Ot.queryMostGranularFormatUnit = f;
			var g = "\v",
				p = "",
				v = "",
	...
	var Qt = Ot.formatDate,
		Xt = Ot.formatRange,
		Kt = Ot.oldMomentFormat;
	Ot.Class = ct, ct.extend = function() {
		var t, e, n = arguments.length;
		for (t = 0; t < n; t++) e = arguments[t], t < n - 1 && ht(this, e);
		return dt(this, e || {})
	}, ct.mixin = function(t) {
		ht(this, t)
	...
	var Jt = Ot.EmitterMixin = {
		...
		ie = Ot.DragListener = ct.extend(te, {
			options: null,
			subjectEl: null,
			originX: null,
			originY: null,
			...
			startInteraction: function(e, n) {
				var i = D(e);
				if ("mousedown" === e.type) {
					if (se.get().shouldIgnoreMouse()) return;
					if (!w(e)) return;
					e.preventDefault()
				}
	...
	ie.mixin({
		...
		updateAutoScroll: function(t) {
			var e, n, i, r, s = this.scrollSensitivity,
				...
				l = 0,
				a = 0;
			o && (e = (s - (b(t) - o.top)) / s, n = (s - (o.bottom - b(t))) / s, i = (s - (E(t) - o.left)) / s, r = (s - (o.right - E(t))) / s, e >= 0 && e <= 1 ? l = e * this.scrollSpeed * -1 : n >= 0 && n <= 1 && (l = n * this.scrollSpeed), i >= 0 && i <= 1 ? a = i * this.scrollSpeed * -1 : r >= 0 && r <= 1 && (a = r * this.scrollSpeed)), this.setScrollVel(l, a)
		},
	...
	var re = ie.extend({
		...
		handleInteractionStart: function(t) {
			...
			this.component.hitsNeeded(), this.computeScrollBounds(), t ? (n = {
				left: E(t),
				top: b(t)
			}, i = n, r && (e = h(r), i = R(i, e)), this.origHit = this.queryHit(i.left, i.top), r && this.options.subjectCenter && (this.origHit && (e = x(this.origHit, e) || e), i = I(e)), this.coordAdjust = k(i, n)) : (this.origHit = null, this.coordAdjust = null), ie.prototype.handleInteractionStart.apply(this, arguments)
		},
		handleDragStart: function(t) {
			var e;
			ie.prototype.handleDragStart.apply(this, arguments), e = this.queryHit(E(t), b(t)), e && this.handleHitOver(e)
		},
		handleDrag: function(t, e, n) {
			var i;
			ie.prototype.handleDrag.apply(this, arguments), i = this.queryHit(E(n), b(n)), pt(i, this.hit) || (this.hit && this.handleHitOut(), i && this.handleHitOver(i))
		},
	...
	var oe = ct.extend(te, {
		...
		le = Ot.Grid = ct.extend(te, {
			...
			dayMousedown: function(t) {
				var e = this.view;
				e.isSelected || e.selectedEvent || (this.dayClickListener.startInteraction(t), e.opt("selectable") && this.daySelectListener.startInteraction(t, {
	...
	le.mixin({
		...
		buildBusinessHourEvents: function(e, n) {
			...
			return null == n && (n = r.options.businessHours), i = r.computeBusinessHourEvents(e, n), !i.length && n && (i = [t.extend({}, we, {
				start: this.view.end,
				end: this.view.end,
				dow: null
			})]), i
		...
		buildSegDragListener: function(t) {
			...
			var d = this.segDragListener = new re(l, {
				scroll: l.opt("dragScroll"),
				subjectEl: u,
				subjectCenter: !0,
				interactionStart: function(i) {
					t.component = r, e = !1, n = new oe(t.el, {
		...
		buildSegSelectListener: function(t) {
			var e = this,
				...
				i = t.event;
			if (this.segDragListener) return this.segDragListener;
			var r = this.segDragListener = new ie({
		...
		computeEventDrop: function(t, e, n) {
			...
			return o.hasTime() === l.hasTime() ? (i = this.diffDates(l, o), n.allDay && W(i) ? (r = {
				...
				allDay: !1
			}, s.normalizeEventTimes(r)) : r = mt(n), r.start.add(i), r.end && r.end.add(i)) : r = {
				start: l.clone(),
				end: null,
				allDay: !l.hasTime()
			}, r
		...
		listenToExternalDrag: function(t, e, n) {
			var i, r = this,
				...
				a = Dt(t),
				u = r.externalDragListener = new re(this, {
					interactionStart: function() {
		...
		buildSegResizeListener: function(t, e) {
			var n, i, r = this,
				...
				c = t.event,
				d = a.getEventEnd(c),
				h = this.segResizeListener = new re(this, {
					scroll: l.opt("dragScroll"),
					subjectEl: u,
					interactionStart: function() {
						n = !1
		...
		computeEventResize: function(t, e, n, i) {
			...
			return r = {
					...
					allDay: i.allDay
				}, r.allDay && W(l) && (r.allDay = !1, o.normalizeEventTimes(r)), r[t].add(l), r.start.isBefore(r.end) || (s = this.minResizeDuration || (i.allDay ? o.defaultAllDayEventDuration : o.defaultTimedEventDuration), "start" == t ? r.start = r.end.clone().subtract(s) : r.end = r.start.clone().add(s)),
				r
		},
		...
		invertRanges: function(t) {
			var e, n, i = this.view,
				...
				o = [],
				l = r;
			for (t.sort(bt), e = 0; e < t.length; e++) n = t[e], n.start > l && o.push({
				start: l,
				end: n.start
			}), l = n.end;
			return l < s && o.push({
	...
	var ae = Ot.DayTableMixin = {
			...
			renderHeadDateCellHtml: function(t, e, n) {
				...
				return 1 === this.rowCnt ? r = r.concat(this.getDayClasses(t, !0)) : r.push("fc-" + _t[t.day()]), '<th class="' + r.join(" ") + '"' + (1 === this.rowCnt ? ' data-date="' + t.format("YYYY-MM-DD") + '"' : "") + (e > 1 ? ' colspan="' + e + '"' : "") + (n ? " " + n : "") + ">" + i.buildGotoAnchorHtml({
					date: t,
		...
		ue = Ot.DayGrid = le.extend(ae, {
			...
			renderDates: function(t) {
				...
				for (this.el.html(o), this.rowEls = this.el.find(".fc-row"), this.cellEls = this.el.find(".fc-day"), this.rowCoordCache = new ne({
						els: this.rowEls,
						isVertical: !0
					}), this.colCoordCache = new ne({
	...
	ue.mixin({
		...
		buildSegLevels: function(t) {
			...
			for (this.sortEventSegs(t), e = 0; e < t.length; e++) {
				for (n = t[e], i = 0; i < r.length && Tt(n, r[i]); i++);
				n.level = i, (r[i] || (r[i] = [])).push(n)
			}
			for (i = 0; i < r.length; i++) r[i].sort(Ct);
			return r
		},
	...
	var ce = Ot.TimeGrid = le.extend(ae, {
		slotDuration: null,
		snapDuration: null,
		snapsPerSlot: null,
		minTime: null,
		...
		renderDates: function() {
			this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new ne({
				els: this.colEls,
				isHorizontal: !0
			}), this.slatCoordCache = new ne({
				els: this.slatEls,
				isVertical: !0
	...
	ce.mixin({
		...
		computeFgSegHorizontals: function(t) {
			var e, n, i;
			if (this.sortEventSegs(t), e = Ht(t), xt(e), n = e[0]) {
	...
	var de = Ot.View = ct.extend(Jt, te, {
			type: null,
			name: null,
			title: null,
			calendar: null,
			...
			computeTitle: function() {
				var t, e;
				return "year" === this.intervalUnit || "month" === this.intervalUnit ? (t = this.intervalStart, e = this.intervalEnd) : (t = this.start, e = this.end), this.formatRange({
					start: this.calendar.applyTimezone(t),
					end: this.calendar.applyTimezone(e)
			...
			formatRange: function(t, e, n) {
				var i = t.end;
				return i.hasTime() || (i = i.clone().subtract(1)), Xt(t.start, i, e, n, this.opt("isRTL"))
			},
			...
			buildGotoAnchorHtml: function(e, n, i) {
				var r, s, o, l;
				return t.isPlainObject(e) ? (r = e.date, s = e.type, o = e.forceOff) : r = e, r = Ot.moment(r), l = {
			...
			whenEventsSet: function() {
				var t = this;
				return this.isEventsSet ? ft.resolve(this.getCurrentEvents()) : new ft(function(e) {
					t.one("eventsSet", e)
				})
			},
	...
	var fe = Ot.Calendar = ct.extend({
		...
		getUnitViewSpec: function(e) {
			var n, i, r;
			if (t.inArray(e, Yt) != -1)
				for (n = this.header.getViewsWithButtons(), t.each(Ot.views, function(t) {
						n.push(t)
					}), i = 0; i < n.length; i++)
					if (r = this.getViewSpec(n[i]), r && r.singleUnit == e) return r
		},
		buildViewSpec: function(t) {
			for (var i, r, s, o, l = this.overrides.views || {}, a = [], u = [], c = [], d = t; d;) i = At[d], r = l[d], d = null, "function" == typeof i && (i = {
				class: i
	...
	var ge = Ot.locales = {};
	Ot.datepickerLocale = function(e, n, i) {
		var r = ge[e] || (ge[e] = {});
		r.isRTL = i.isRTL, r.weekNumberTitle = i.weekHeader, t.each(pe, function(t, e) {
			r[t] = e(i)
		...
		var r, s;
		r = ge[e] || (ge[e] = {}), i && (r = ge[e] = n([r, i])), s = Ft(e), t.each(ve, function(t, e) {
			null == r[t] && (r[t] = e(s, r))
	...
	Ot.locale("en", fe.englishDefaults), Ot.sourceNormalizers = [], Ot.sourceFetchers = [];
	var ye = {
			dataType: "json",
			cache: !1
		},
		Se = 1;
	fe.prototype.mutateSeg = function(t, e) {
	...
	fe.prototype.getCurrentBusinessHourEvents = function(t) {
		...
		var r, s, o = this.getView(),
			l = [];
		for (r = 0; r < n.length; r++) s = n[r], i && !s.dow || (s = t.extend({}, we, s), e && (s.start = null, s.end = null), l.push.apply(l, this.expandEvent(this.buildEventFromInput(s), o.start, o.end)));
		return l
	};
	var Ee = Ot.BasicView = de.extend({
			scroller: null,
			dayGridClass: ue,
			dayGrid: null,
			dayNumbersVisible: !1,
			...
			instantiateDayGrid: function() {
				var t = this.dayGridClass.extend(be);
				return new t(this)
			},
			setRange: function(t) {
			...
			computeRange: function(t) {
				var e = de.prototype.computeRange.call(this, t);
		...
		De = Ot.MonthView = Ee.extend({
			computeRange: function(t) {
				var e, n = Ee.prototype.computeRange.call(this, t);
	...
	var Te = Ot.AgendaView = de.extend({
			scroller: null,
			timeGridClass: ce,
			timeGrid: null,
			dayGridClass: ue,
			...
			setHeight: function(t, e) {
				var n, s, o;
				this.bottomRuleEl.hide(), this.scroller.clear(), r(this.noScrollRowEls), this.dayGrid && (this.dayGrid.removeSegPopover(), n = this.opt("eventLimit"), n && "number" != typeof n && (n = xe), n && this.dayGrid.limitRows(n)), e || (s = this.computeScrollerHeight(t), this.scroller.setHeight(s), o = this.scroller.getScrollbarWidths(), (o.left || o.right) && (i(this.noScrollRowEls, o), s = this.computeScrollerHeight(t), this.scroller.setHeight(s)), this.scroller.lockOverflow(o), this.timeGrid.getTotalSlatHeight() < s && this.bottomRuleEl.show())
			},
			computeScrollerHeight: function(t) {
				return t - c(this.el, this.scroller.el)
			},
	...
	var Ie = de.extend({
			...
			scroller: null,
			initialize: function() {
				this.grid = new ke(this), this.scroller = new he({
					overflowX: "hidden",
					overflowY: "auto"
				})
			},
		...
		ke = le.extend({
			...
			handleSegClick: function(e, n) {
				var i;
				le.prototype.handleSegClick.apply(this, arguments), t(n.target).closest("a[href]").length || (i = e.event.url, i && !n.isDefaultPrevented() && (window.location.href = i))
			},
			renderFgSegs: function(t) {
