! function(e, t) {
	...
	ie.fn.extend({
		val: function(e) {
			...
			})) : i ? (t = ie.valHooks[i.type] || ie.valHooks[i.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n = t.get(i, "value")) ? n : (n = i.value, "string" == typeof n ? n.replace(ft, "") : null == n ? "" : n)) : void 0
		}
	}), ie.extend({
		valHooks: {
			option: {
...
! function(e) {
	...
	return n.defaults = {
		...
		return (i = e.extend({}, n.defaults, i)).hash && location.hash && (i.target && window.scrollTo(0, 0), t(0, location, i)), i.lazy ? this.on(i.event, "a,area", function(e) {
...
! function(t) {
	...
	function Y(t, e, n, a, i, o) {
		var r, u;
		e.target;
		r = t.targetTouches, u = t.timeStamp - e.timeStamp, e.type = "movestart", e.distX = a, e.distY = i, e.deltaX = a, e.deltaY = i, e.pageX = n.pageX, e.pageY = n.pageY, e.velocityX = a / u, e.velocityY = i / u, e.targetTouches = r, e.finger = r ? r.length : 1, e._handled = l, e._preventTouchmoveDefault = function() {
			t.preventDefault()
		}, x(e.target, e), o(e.identifier)
	}
	...
	t.event.special.movestart = {
		...
		teardown: function(t) {
			return R(this, "dragstart drag", o), R(this, "mousedown touchstart", r), R(this, "movestart", X), !0
		},
		add: function(t) {
			"move" !== t.namespace && "moveend" !== t.namespace && (F(this, "dragstart." + t.guid + " drag." + t.guid, o, e, t.selector), F(this, "mousedown." + t.guid, r, e, t.selector))
		},
		remove: function(t) {
			"move" !== t.namespace && "moveend" !== t.namespace && (R(this, "dragstart." + t.guid + " drag." + t.guid), R(this, "mousedown." + t.guid))
		},
		_default: function(t) {
			var a, o;
			t._handled() && (a = {
				...
				touch: e,
				timeStamp: e
			}, t.identifier === e ? (F(t.target, "click", i), F(document, C.move, w, o), F(document, C.end, y, o)) : (t._preventTouchmoveDefault(), F(document, K.move + "." + t.identifier, S, o), F(document, K.end + "." + t.identifier, k, o)))
		}
		...
		u(t) && (e = {
			...
			startY: t.pageY,
			timeStamp: t.timeStamp
		}, F(document, C.move, m, e), F(document, C.cancel, f, e))
		...
		}, F(document, K.move + "." + e.identifier, v, n), F(document, K.cancel + "." + e.identifier, p, n))
	...
	t.fn.twentytwenty = function(e) {
		...
		return this.each(function() {
			...
			var l = function(t) {
				...
				f = function(t) {
					var e = l(t);
					c.css("vertical" === a ? "top" : "left", "vertical" === a ? e.ch : e.cw), v(e)
				};
			...
			c.on("movestart", function(t) {
				(t.distX > t.distY && t.distX < -t.distY || t.distX < t.distY && t.distX > -t.distY) && "vertical" !== a ? t.preventDefault() : (t.distX < t.distY && t.distX < -t.distY || t.distX > t.distY && t.distX > -t.distY) && "vertical" === a && t.preventDefault(), i.addClass("active"), p = i.offset().left, y = i.offset().top, h = r.width(), u = r.height()
			}), c.on("moveend", function(t) {
				i.removeClass("active")
			}), c.on("move", function(t) {
				i.hasClass("active") && ((n = "vertical" === a ? (t.pageY - y) / u : (t.pageX - p) / h) < 0 && (n = 0), n > 1 && (n = 1), f(n))
